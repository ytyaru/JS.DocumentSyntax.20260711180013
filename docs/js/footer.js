...
class Footer {
    ...
    #copyright() { return small('©', time({datetime:this._created}, '20260711180002'), this.#author()) }
    ...
    #project() { return a(this.#externalLinkAttr(({href:`https://github.com/${this._author}/DocumentSyntax/`})), img({class:'icon', src:`${this._prePath}asset/image/logo/github/black.svg`})) }
